...
from Recursos.indices_extraccion import indice_extraccion
...
class Recurso (metaclass=ABCMeta): 
    ...
    def __init__(self, ecosistema, nombre):
        self.cantidad = 0
        self.nombre = nombre
        self.indice_extraccion = self.__asignar_indice_extraccion(ecosistema)

    def __asignar_indice_extraccion(self, ecosistema): 
